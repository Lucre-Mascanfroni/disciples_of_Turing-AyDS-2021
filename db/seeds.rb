...
q1 = Question.new(name: '1. ', description:'Me trasladaría a una zona agrícola-ganadera para ejercer mi profesión.', number: 1, type: 'Boolean')
q1.save
...
q2 = Question.new(name:'2. ', description:'Tengo buena memoria y no me cuesta estudiar y retener fórmulas y palabras técnicas.', number: 2, type: 'Boolean')
q2.save
...
q3 = Question.new(name:'3. ', description:'Me gusta escribir. En general mis trabajos son largos y están bien organizados.', number: 3, type: 'Boolean')
q3.save
...
q4 = Question.new(text:'4. ', description:'Sé quien es Steven Hawking: Conozco y me atraen sus descubrimientos.', number: 4, type: 'Boolean')
q4.save
	ch1_q4 = Choice.new(text:'1. Si', question:q4)
		Outcome.create(choice: ch1_q4, career: fisica)
	ch2_q4 = Choice.new(text:'2. No', question:q4)

q5 = Question.new(text:'5. ', description: 'Me actualizo respecto de los avances tecnológicos y me intereso por investigar y conocer.', number: 5, type: 'Boolean')
q5.save
...
q6 = Question.new(text:'6. ', description: 'Sé quien es Andy Warhol y a qué movimiento artístico pertenece. Me apasiona conocer acerca del arte y sus exponentes.', number: 6, type: 'Boolean')
q6.save
	ch1_q6 = Choice.new(text:'1. Si', question:q6)
		Outcome.create(choice: ch1_q6, career: arte)
	ch2_q6 = Choice.new(text:'2. No', question:q6)

q7 = Question.new(text:'7. ', description: 'En general me intereso por las dificultades que ha tenido que atravesar la humanidad y cómo lo ha superado.', number: 7, type: 'Boolean')
q7.save
...
q8 = Question.new(name:'8. ', description:'Me apasiona leer y no me importa si el libro que elijo tiene muchas páginas, para mí es un gran entretenimiento.', number: 8, type: 'Boolean')
q8.save
...
q9 = Question.new(text:'9. ', description: 'Me atrae conocer los procesos y las áreas que hacen funcionar a las empresas.', number: 9, type: 'Boolean')
q9.save
...
q10 = Question.new(name:'10. ', description:'Me siento identificado con el pensamiento de algunos filósofos y escritores.', number: 10, type: 'Boolean')
q10.save
...
q11 = Question.new(text:'11. ', description: 'Me encanta estudiar el cuerpo humano y conocer cómo funciona. Además, no me impresiona la sangre.', number: 11, type: 'Boolean')
q11.save
...
q12 = Question.new(name:'12. ', description:'Si pudiera elegir, pasaría mucho tiempo diseñando novedosos objetos o edificios en mi computadora.', number: 12, type: 'Boolean')
q12.save
...
q13 = Question.new(name:'13. ', description:'Si mi blog fuera temático, trataría acerca de: ', number: 13, type: 'MChoice')
q13.save
...
q14 = Question.new(name:'14. ', description:'Integraría un equipo de trabajo encargado de producir un audiovisual sobre: ', number: 14, type: 'MChoice')
q14.save
...
q15 = Question.new(name:'15. ', description:'Sería importante destacarme como: ', number: 15, type: 'MChoice')
q15.save
