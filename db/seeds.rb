...
q1 = Question.create(name: '1. ', description: 'Me trasladaría a una zona agrícola-ganadera para ejercer mi profesión.', number: 1, type: 'SINGLE-CHOICE')
...
q2 = Question.create(name: '2. ', description: 'Tengo buena memoria y no me cuesta estudiar y retener fórmulas y palabras técnicas.', number: 2, type: 'SINGLE-CHOICE')
...
q3 = Question.create(name: '3. ', description: 'Me gusta escribir. En general mis trabajos son largos y están bien organizados.', number: 3, type: 'SINGLE-CHOICE')
...
q4 = Question.create(name: '4. ', description: 'Sé quien es Steven Hawking: Conozco y me atraen sus descubrimientos.', number: 4, type: 'SINGLE-CHOICE')
...
q5 = Question.create(name: '5. ', description: 'Me actualizo respecto de los avances tecnológicos y me intereso por investigar y conocer.', number: 5, type: 'SINGLE-CHOICE')
...
q6 = Question.create(name: '6. ', description: 'Sé quien es Andy Warhol y a qué movimiento artístico pertenece. Me apasiona conocer acerca del arte y sus exponentes.', number: 6, type: 'SINGLE-CHOICE')
	ch1_q6 = Choice.create(text: 'Si', question: q6)
		Outcome.create(choice: ch1_q6, career: arte)
	ch2_q6 = Choice.create(text: 'No', question: q6)

q7 = Question.create(name: '7. ', description: 'En general me intereso por las dificultades que ha tenido que atravesar la humanidad y cómo lo ha superado.', number: 7, type: 'SINGLE-CHOICE')
...
q8 = Question.create(name: '8. ', description: 'Me apasiona leer y no me importa si el libro que elijo tiene muchas páginas, para mí es un gran entretenimiento.', number: 8, type: 'SINGLE-CHOICE')
...
q9 = Question.create(name: '9. ', description: 'Me atrae conocer los procesos y las áreas que hacen funcionar a las empresas.', number: 9, type: 'SINGLE-CHOICE')
...
q10 = Question.create(name: '10. ', description: 'Me siento identificado con el pensamiento de algunos filósofos y escritores.', number: 10, type: 'SINGLE-CHOICE')
...
q11 = Question.create(name: '11. ', description: 'Me encanta estudiar el cuerpo humano y conocer cómo funciona. Además, no me impresiona la sangre.', number: 11, type: 'SINGLE-CHOICE')
...
q12 = Question.create(name: '12. ', description: 'Si pudiera elegir, pasaría mucho tiempo diseñando novedosos objetos o edificios en mi computadora.', number: 12, type: 'SINGLE-CHOICE')
...
q13 = Question.create(name: '13. ', description: 'Si mi blog fuera temático, trataría acerca de: ', number: 13, type: 'SINGLE-CHOICE')
...
q14 = Question.create(name: '14. ', description: 'Integraría un equipo de trabajo encargado de producir un audiovisual sobre: ', number: 14, type: 'SINGLE-CHOICE')
...
q15 = Question.create(name: '15. ', description: 'Sería importante destacarme como: ', number: 15, type: 'SINGLE-CHOICE')
